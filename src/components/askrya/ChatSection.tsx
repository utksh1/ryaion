...
export const ChatSection = () => {
    ...
    return (
        <GlassCard className="flex flex-col flex-1 min-h-[550px] border-lavender/20 bg-gradient-to-b from-white/[0.03] to-black/40 backdrop-blur-3xl overflow-hidden group">
            {/* Header */}
